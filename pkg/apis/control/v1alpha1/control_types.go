...
func (b *BgpNeighbor) GetAddress() string {
	return b.Neighbors.List.BgpNeighborResp.PeerAddress.Text
}

func (b *BgpNeighbor) GetState() string {
	return b.Neighbors.List.BgpNeighborResp.State.Text
}
